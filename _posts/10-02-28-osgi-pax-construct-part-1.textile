...
excerpt: Сегодня хотел бы рассказать о таком инструменте, как Pax Construct. Это фактически индустриальный стандарт для ведения проектов на основе технологии <b>OSGi</b>. Он доступен как стандэлон приложение, так и как плагин для maven2. <b>Pax Construct</b> предоставляет вам множество инструментов для проектов на основе OSGi, которые помогут вам быстро создавать и управлять вашим проектом.
published: true
categories:
- java
- osgi
- pax
image: http://lh3.ggpht.com/_wN3Yn5K_LYs/S4qgrm96rhI/AAAAAAAAALs/8oaJzXA9RLE/pax-construct.png
---
